...
**Reverb.js** is a Web Audio API extension for creating reverb nodes with an accompanying impulse-response reverb library. You can quickly load any of the provided impulse responses or use your own. This project and the associated impulse responses are provided under the [Attribution Share Alike Creative Commons](http://creativecommons.org/licenses/by-sa/3.0/) license.
...
## Demo
Here is a [demo](http://reverbjs.org.s3-website-us-east-1.amazonaws.com) of the Reverb.js with each of the samples in the reverb library.
